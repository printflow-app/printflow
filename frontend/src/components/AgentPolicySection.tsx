          ...
          >
            <div className="mt-3 space-y-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-semibold text-slate-400 mb-2 leading-relaxed">
                ...
                <div className="space-y-2">
                  {AREAS.map((a) => {
                    ...
                    return (
                      ...
                      >
                        <p className="text-[12px] font-bold text-slate-700">{a.label}</p>
                        <p className="text-[10px] font-semibold text-slate-400 mt-0.5 leading-relaxed">{a.desc}</p>
                        <div className="flex gap-1.5 mt-2">
                          {(['off', 'propose', 'execute'] as AreaMode[]).map((m) => (
                            <button
                              ...
                              className={`h-7 px-2.5 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors ${
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="min-w-0">
                          <span className={`block text-[12px] font-bold ${on ? 'text-orange-700' : 'text-slate-700'}`}>
                            {a.label}
                          </span>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 text-[12px] font-medium text-slate-700 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-orange-500 leading-relaxed resize-y"
                />
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-16 h-9 text-center text-sm font-bold bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-orange-500"
                />
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">amal</span>
              </div>
