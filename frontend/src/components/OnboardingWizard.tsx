        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-[11px] text-slate-400 mt-2">Keyinroq Filiallar bo'limidan qo'shimcha filiallarni qo'shishingiz mumkin.</p>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div>
                <label className="text-[10px] font-bold uppercase text-slate-500 tracking-widest">Xizmat nomi</label>
                <input
                  value={serviceName}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[10px] font-bold uppercase text-slate-500 tracking-widest">Asosiy narx (UZS)</label>
                  <input
                    type="number"
                    value={servicePrice}
                ...
                <div>
                  <label className="text-[10px] font-bold uppercase text-slate-500 tracking-widest">Birlik</label>
                  <select
                    value={serviceUnit}
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              <div>
                <label className="text-[10px] font-bold uppercase text-slate-500 tracking-widest">Ism Familiya</label>
                <input
                  value={empName}
              ...
              <div>
                <label className="text-[10px] font-bold uppercase text-slate-500 tracking-widest">Telefon (ixtiyoriy)</label>
                <input
                  value={empPhone}
