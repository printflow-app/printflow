        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-5 sm:p-6 shadow-sm space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <label className="inline-flex items-center justify-center gap-2 bg-orange-50 hover:bg-orange-100 text-orange-700 h-9 px-4 text-[11px] font-bold uppercase tracking-widest rounded-lg cursor-pointer transition-all">
                    Rasm tanlash
                    <input
                      type="file"
                      accept="image/*"
                  ...
                  {branding.logoBase64 && (
                    <button
                      onClick={removeLogo}
                      className="ml-2 inline-flex items-center justify-center h-9 px-3 text-[11px] font-bold uppercase tracking-widest rounded-lg bg-slate-100 hover:bg-rose-50 hover:text-rose-600 text-slate-600 transition-all"
                    >
                      O'chirish
                    </button>
                  )}
                  <p className="text-[10px] text-slate-400 mt-2">PNG/JPG. Maks 300 KB. Kichik logoda yaxshi ko'rinadi.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Matnlar</h4>
              <TextField
                ...
                {COLOR_FIELDS.map(field => (
                  <div key={field.key} className="flex items-start gap-3 p-3 rounded-xl border border-slate-100 hover:border-orange-200 hover:bg-orange-50/30 transition-all">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-[12px] font-bold text-slate-800 uppercase tracking-tight">{field.label}</p>
                      <p className="text-[10px] text-slate-500 leading-snug mt-0.5">{field.description}</p>
                      <input
                        type="text"
                        value={(branding as any)[field.key] || DEFAULTS[field.key]}
                        onChange={e => updateColor(field.key, e.target.value)}
                        className="mt-1.5 h-7 px-2 w-28 text-[11px] font-mono font-bold uppercase border border-slate-200 rounded-md focus:outline-none focus:border-orange-400"
                        spellCheck={false}
                      />
                    </div>
                  </div>
