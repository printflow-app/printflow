                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline justify-between gap-3">
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">/ {svc.unit}</p>
                    </div>
                  </div>
                    ...
                    <div className="mt-3 space-y-2">
                      {groups.map(group => (
                        <div key={group.name} className="flex items-start gap-3 flex-wrap">
                          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pt-1.5 min-w-[80px]">
                            {group.name}:
                          </p>
          ...
          <div className="flex-1 overflow-y-auto custom-scroll p-3 space-y-2">
            {cart.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-slate-300">
                ...
                <p className="text-[11px] font-bold uppercase tracking-widest text-center">Savat bo'sh.<br/>Mahsulot qo'shing</p>
              </div>
            ) : (
              cart.map(line => {
                  ...
                  <div key={line.id} className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="min-w-0">
                        ...
                        {optionLabel && (
                          <p className="text-[10px] text-slate-500 truncate">{optionLabel}</p>
                        )}
                      </div>
                      <button
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="text-right">
                        <p className="text-[10px] text-slate-400">{formatPrice(unitPrice)} × {line.quantity}</p>
